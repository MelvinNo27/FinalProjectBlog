...
<div class="card-box d-flex justify-content-center mb-4">
    <div class="card shadow rounded border-0" style="width: 35rem">
        <h5 class="card-title mt-3 fw-bold ms-3">
            ...
            <!-- Download Button -->
            <a href="{{ asset('storage/'.$post->image) }}" target="_blank" download="{{ $post->image }}" class="btn btn-sm btn-outline-primary float-end me-3">
                Download <i class="ms-2 fa-solid fa-download"></i>
            </a>
        </h5>
